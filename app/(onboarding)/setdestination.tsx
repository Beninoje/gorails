  ...
  return (
    <SafeAreaView className="flex-1 bg-black px-6">
      ...
      <View className="items-center pt-4">
        <Text className="text-white text-2xl font-bold text-center">Finally, what is your destination?</Text>
        <Text className="text-white pt-4 text-lg font-light text-center">
          Your destination is the station that you'd like to end up at. It can't be the same station as your origin.
        </Text>
      </View>
